...
$R.settings.assignInnerHTML(_body,_iframeBodyHTML);}
else
...
$R.footnotedLinksCount=0;var _f=$R.$iframeFootnotedLinks.get(0);while(_f.firstChild){_f.removeChild(_f.firstChild);}};return $R;}
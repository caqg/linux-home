        ...
        var _frame = document.createElement('iframe'),
            _frameHTML = ''                         +
                ...
                '<html id="html"><body id="body">'  +
                    '<script type="text/javascript" src="'+_path_main+'third_party/jquery/jquery.js">' +    '</script>' +
                    ''                              +
                    '<script type="text/javascript" src="'+_path_main+'the_components/detect/detect.js">' + '</script>' +
                    '<script type="text/javascript" src="'+_path_main+'the_components/next/next.js">' +     '</script>' +
                    ''                              +
                    '<script type="text/javascript" src="'+_path_main+'in_page/init_and_call.js">' +     '</script>' +
                '</body></html>'                    +
            '';

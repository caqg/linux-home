        ...
        //  ==============
            ...
            var _check1 = function ()
            {
                ...
                else
                {
                    ...
                    (function () { 
                        var document = { 'open': function () {}, 'write': function () {}, 'close': function () {} };
                        document.open(); document.write('<div>Three lines above there is a call to doDocumentWrite, which is an alias for document.open().write().close().</div>'); document.close();
                    })();
                }

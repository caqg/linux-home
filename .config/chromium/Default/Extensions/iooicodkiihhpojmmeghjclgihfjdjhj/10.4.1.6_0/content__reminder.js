...
//  main object
//  ===========
    window.__readable_by_evernote__content__reminder = {};
    ...
    (function ($C) {
        ...
        //  ========
            window.document.addEventListener('click', function(_event)
            {
                ...
                switch (_short_event_name)
                {
                    case 'track--reminder--shown':   _m({ '_type': _short_event_name }); _stop = true; break;
                    case 'track--reminder--clicked': _m({ '_type': _short_event_name }); _stop = true; break;
                    case 'track--reminder--closed':  _m({ '_type': _short_event_name }); _stop = true; break;
                }
        ...
        //  =========
            ...
            (function ($C) {
                ...
                chrome.extension.sendMessage({ '_type': "to-chrome--load-info" }, function(response)
                {
                    ...
                    //  inject
                    $C.inject_script_and_definitions(document, 'chrome-extension://iooicodkiihhpojmmeghjclgihfjdjhj/in_reminder/script.js', $C.loaded_info.as_html);
                });

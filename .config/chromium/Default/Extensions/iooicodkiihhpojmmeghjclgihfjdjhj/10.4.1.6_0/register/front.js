...
//  ===
    (function ($R, $B) {
        ...
        //  vars
        $R.paths = { 'main': 'chrome-extension://iooicodkiihhpojmmeghjclgihfjdjhj/', 'evernote': 'https://www.evernote.com/' };
        ...
        //  ======
            $R.bind__ui_events = function ()
            {
                ...
                {
                    //  return
                    if ($B.$bootstrap.profiles_as_string == 'in_cn') {}else { return; }
                ...
                {
                    //  return
                    if ($B.$bootstrap.profiles_as_string == 'cn_in') {}else { return; }

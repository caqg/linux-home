            ...
            chrome.extension.onMessage.addListener(function(message, sender, sendResponse)
            {
                ...
                switch (_short_event_name)
                {
                    case 'evernote--login--request-second-factor':
                        ...
                        if (_number) { _number.innerHTML = message._deliveryHint; }
                        break;
                }
        ...
        //  =========
            ...
            (function ($C) {
                ...
                chrome.extension.sendMessage({ '_type': "to-chrome--load-info" }, function(response)
                {
                    ...
                    //  inject
                    $C.inject_script_and_definitions(document, 'chrome-extension://iooicodkiihhpojmmeghjclgihfjdjhj/in_popup/login/script.js', $C.loaded_info.as_html);
                });

...
//  ===================================
    (function ($C) {
        ...
        (function () {
            ...
            //  ========
                var _inject_clearly = function (__document, __and_action)
                {
                    ...
                    //  path
                    var _path_main = 'chrome-extension://iooicodkiihhpojmmeghjclgihfjdjhj/';
                    ...
                    //  ============================
                        ...
                        if (__document.getElementById(_cssIDs.in_isolation))
                        {
                            ...
                            _script.setAttribute('src', _path_main+'in_page/call'+(__and_action ? '_and_'+__and_action : '')+'.js');
                    ...
                    //  ===============================================
                        ...
                        //  =============
                            ...
                            window.setTimeout(function ()
                            {
                                ...
                                _script.setAttribute('type', 'text/javascript');
                                _script.setAttribute('src', _path_main+'in_page/inject_and_init_and_call.js');
                        ...
                        //  ================
                            ...
                            {
                                //  frame url
                                var _frame_url = _path_main+'in_isolation/isolation.html?x=y',
        ...
        (function () {
            ...
            //  add keyboard hook
            //  =================
                var _add_keyboard_hook = function (__window, __keys, __get_key_combo_from_event, __inject)
                {
                    __window.addEventListener('keydown', function(_event)
                    {
                ...
                (function ()
                {
                    ...
                    _inject_reminder = function (_window, _info)
                    {
                        ...
                        //  ======================================
                            ...
                            //  no data on when Clearly was last used
                        ...
                        //  ===============
                            ...
                            var _frame = _doc.createElement('iframe'),
                                _frame_url = _path_main + 'in_reminder/page.html?x=y' +

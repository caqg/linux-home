...
return elements.join('&');};this._generateSignature=function(){this._action="POST";if(this._oauthEscape(this._secrets.oauth_secret)&&this._path=="https://api.twitter.com/1.1/account/verify_credentials.json")

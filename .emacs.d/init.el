...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (color-theme-solarized yaoddmuse xml-rpc xcscope wiki-nav wiki wget vlf vkill vimrc-mode viewer vector-utils uuid undo-tree thing-cmds tdd tabbar systemtap-mode syslog-mode syntax-subword sudo-ext string-utils string-edit strie ssh-config-mode ssh sparkline sml-mode slime-annot shell-toggle shell-here shell-command sane-term s-buffer ruby-tools ruby-test-mode ruby-interpolation ruby-hash-syntax ruby-end ruby-electric relative-line-numbers rainbow-mode python-mode python-info px prolog preproc-font-lock pp+ pod-mode perl-myvar perl-completion peep-dired pcsv path-headerline-mode paredit-menu paredit-everywhere orgtbl-show-header org-pandoc org-mime org-journal org-jira org-download org-context org-cliplink org-bullets org-ac nasm-mode move-dup markdown-toc lib-requires kv jira javadoc-lookup javadoc-help ipython interval-tree http-post-simple ht header2 gtags gscholar-bibtex gitignore-mode gitconfig-mode gitattributes-mode git-rebase-mode git-commit-mode git ess-smart-underscore ess-R-object-popup ess-R-data-view edit-list ediprolog edebug-x ecb dired-toggle-sudo dired-narrow dircmp dict-tree debbugs csv-nav cperl-mode company-math company-inf-ruby company-ess company-c-headers codesearch cmake-mode charmap cedit bison-mode bigint backtrace-mode auto-complete-exuberant-ctags auto-complete-c-headers auto-complete-auctex auctex apt-utils anything-replace-string anything-git-grep anything-git-files anything-exuberant-ctags ant all-ext aggressive-indent aggressive-fill-paragraph aes ada-ref-man ada-mode ac-c-headers)))
 '(recentf-mode t)

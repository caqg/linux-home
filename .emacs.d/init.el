...
(custom-set-variables
 ...
 '(ecb-source-path
   '(("/work/linux-home" "Remote dots")
     ("/home/cesar/Projects/nmax_compiler" "Flex Logix compiler")
     ("/home/cesar/Projects/weight-generation-tool" "Flex Logix weights tool")))
 ...
 '(package-selected-packages
   '(org-plus-contrib auctex ac-R ac-c-headers ac-emoji ac-etags ac-math ac-octave ac-python ac-slime ada-mode ada-ref-man aes aggressive-fill-paragraph aggressive-indent all all-ext anaconda-mode ant anything-exuberant-ctags anything-git-files anything-git-grep anything-replace-string apt-utils arduino-mode ascii auto-complete-auctex auto-complete-c-headers auto-complete-exuberant-ctags auto-complete-pcmp autodisass-llvm-bitcode backtrace-mode beacon bigint bison-mode button-lock cedit charmap chess cider cl-format cl-lib-highlight clang-format cmake-font-lock cmake-mode cobol-mode codesearch common-lisp-snippets company-c-headers company-ess company-inf-ruby company-math company-quickhelp concurrent context-coloring cperl-mode csharp-mode csv-mode csv-nav ctable ctags ctags-update cuda-mode dash-functional debian-el dict-tree diff-hl diffview dircmp dired-hacks-utils dired-narrow dired-rsync dired-toggle-sudo docker docker-api docker-compose-mode docker-tramp dockerfile-mode dpkg-dev-el dropbox dts-mode dynamic-ruler ecb edebug-x ediprolog edit-at-point edit-list editorconfig-charset-extras editorconfig-custom-majormode editorconfig-domain-specific eldoc-cmake eldoc-eval eldoc-overlay elog epl ess-R-data-view ess-R-object-popup ess-smart-underscore f fasm-mode figlet fill-column-indicator flycheck flymake flymake-python-pyflakes fm form-feed ggtags gh ghub git gitattributes-mode gitconfig-mode gitignore-mode glsl-mode graphql gscholar-bibtex gtags gxref header2 heap hide-comnt hide-lines ht http-post-simple hydra indent-guide inf-ruby inline-docs interval-tree ipython itail j-mode javadoc-help javadoc-lookup jira json-mode json-reformat json-snatcher julia-mode kv latex-extra latex-preview-pane let-alist lexbind-mode lib-requires lisp-extra-font-lock list-utils llvm-mode log4e logito lv magit-filenotify magit-find-file magit-gh-pulls magit-gitflow magit-popup magit-tramp markdown-mode markdown-toc marshal math-symbol-lists memory-usage minimap mmt move-dup multi-term multishell name-this-color nasm-mode nav-flash ninja-mode noflet oauth oberon opencl-mode org-ac org-bullets org-cliplink org-context org-dashboard org-download org-jira org-journal org-magit org-mime org-pandoc orgtbl-show-header ov p4 pandoc-mode paredit paredit-everywhere paredit-menu path-headerline-mode pcache pcre2el pcsv peep-dired perl-completion perl-myvar pkg-info pod-mode pos-tip pp+ preproc-font-lock prolog px python-info python-mode python3-info pythonic quarter-plane queue quick-peek rainbow-mode relative-line-numbers ruby-electric ruby-end ruby-hash-syntax ruby-interpolation ruby-test-mode ruby-tools s-buffer sane-term sed-mode seq shell-command shell-here shell-toggle sicp slime slime-annot slime-docker sml-mode solarized-theme spark sparkline spinner srefactor ssh ssh-config-mode stream strie string-edit string-utils sudo-ext syntax-subword syslog-mode systemd systemtap-mode tNFA tabbar tablist tdd thing-cmds tramp-term treepy trie undo-tree uniquify-files uuid vdiff vector-utils verilog-mode viewer vimrc-mode visible-mark vkill vlf wget wiki wiki-nav wisi xcscope xml-rpc yaexception yaml-mode yasnippet yaxception))

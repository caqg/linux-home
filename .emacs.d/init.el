...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (zenburn-theme yaoddmuse xcscope wiki-nav wiki wget vlf vkill vimrc-mode viewer vector-utils uuid undo-tree ubuntu-theme thing-cmds tdd tabbar systemtap-mode syslog-mode sudo-ext string-utils string-edit strie ssh-config-mode ssh sparkline sml-mode slime-annot shell-toggle shell-here shell-command sane-term s-buffer ruby-tools ruby-test-mode ruby-interpolation ruby-hash-syntax ruby-end ruby-electric relative-line-numbers rainbow-mode python-mode python-info px prolog preproc-font-lock pp+ pod-mode perl-myvar perl-completion peep-dired pcsv path-headerline-mode pastels-on-dark-theme paredit-menu paredit-everywhere pandoc-mode orgtbl-show-header org-pandoc org-mime org-journal org-jira org-download org-context org-cliplink org-bullets org-blog org-ac org noctilux-theme move-dup monochrome-theme markdown-toc lib-requires kv jira javadoc-lookup javadoc-help interval-tree http-post-simple ht header2 gtags gitignore-mode gitconfig-mode gitattributes-mode git-rebase-mode git-commit-mode git ggtags gandalf-theme form-feed ess-smart-underscore ess-R-object-popup ess-R-data-view edit-list ediprolog edebug-x ecb display-theme dired-toggle-sudo dired-narrow dircmp dict-tree debbugs csv-nav csv-mode cperl-mode color-theme-solarized color-theme-emacs-revert-theme codesearch cmake-mode charmap cedit calmer-forest-theme bubbleberry-theme bison-mode bigint backtrace-mode auto-complete-exuberant-ctags auto-complete-c-headers auto-complete-auctex auctex async apt-utils anything-ipython anything-git-grep anything-git-goto anything-git-files anything-exuberant-ctags anything-extension anything-config anything-complete anti-zenburn-theme ant all-ext afternoon-theme aes ada-ref-man ada-mode ac-slime ac-octave ac-math ac-ispell ac-inf-ruby ac-etags ac-dabbrev ac-c-headers)))
 '(recentf-mode t)

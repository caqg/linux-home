;;; wisi-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(fn &key NAME COMPILE-ENV FILE-ENV COMPILER XREF CASE-EXCEPTION-FILES (CASE-FULL-EXCEPTIONS \\='nil) (CASE-PARTIAL-EXCEPTIONS \\='nil) SOURCE-PATH FILE-PRED)")
...
(fn PRJ-FILE INIT-PRJ &optional DOMINATING-FILE)")
...
(fn PRJ-FILE DEFAULT-PRJ &optional DOMINATING-FILE)")
...
(fn PRJ-FILE DEFAULT-PRJ &optional DOM-FILE)")
...
(fn PRJ-FILE DEFAULT-PRJ DOMINATING-FILE &optional DIR)")
...
Symbol can be a nonterminal name, or a state number." t)

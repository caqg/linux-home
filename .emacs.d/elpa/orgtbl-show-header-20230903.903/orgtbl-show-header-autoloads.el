;;; orgtbl-show-header-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
In a table, show the header of the column the point is in." t)
...
(provide 'orgtbl-show-header-autoloads)

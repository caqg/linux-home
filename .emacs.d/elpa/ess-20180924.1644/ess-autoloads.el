...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ess-custom" '("R-" "Rnw-mode-hook" "S+" "S-" "SAS-mode-hook" "comint-highlight-prompt" "ess-" "inferior-" "no-doc")))

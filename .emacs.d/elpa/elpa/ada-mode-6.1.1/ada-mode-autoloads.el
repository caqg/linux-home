...
;;;***

;;;### (autoloads nil "ada-lalr-elisp" "ada-lalr-elisp.el" (0 0 0
;;;;;;  0))
;;; Generated autoloads from ada-lalr-elisp.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ada-lalr-elisp" '("ada-lalr-elisp-")))
...
The major mode for editing Ada code." t nil)

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ada-mode" '("ada-" "which-func-functions" "wisi-inhibit-parse")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ada-process" '("ada-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ada-wisi" '("ada-" "wisi-elisp-parse-indent-hanging-function")))

;;;***

;;;### (autoloads nil "ada-wisi-elisp-parse" "ada-wisi-elisp-parse.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from ada-wisi-elisp-parse.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ada-wisi-elisp-parse" '("ada-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "gnat-core" '("ada-gnat-" "gnat" "gpr-query--sessions")))
...
;;;***

;;;### (autoloads nil "gpr-lalr-elisp" "gpr-lalr-elisp.el" (0 0 0
;;;;;;  0))
;;; Generated autoloads from gpr-lalr-elisp.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "gpr-lalr-elisp" '("gpr-lalr-elisp-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "gpr-process" '("gpr-")))

...

;;;### (autoloads nil "anything" "anything.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "anything" '("anything-" "with-anything-" "define-anything-type-attribute")))

;;;***

;;;### (autoloads nil "anything-complete" "anything-complete.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from anything-complete.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "anything-complete" '("apropos-" "alcs-" "anything-" "execute-command" "zsh-p" "tap-symbol" "complete")))

;;;***

;;;### (autoloads nil "anything-config" "anything-config.el" (0 0
;;;;;;  0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "anything-config" '("ac-" "anything-" "timer" "file" "line" "buffer" "bookmark" "sexp" "variable" "w3m-" "with-anything-show-completion" "eshell-command-aliases-list" "minibuffer-")))

;;;***

;;;### (autoloads nil "anything-grep" "anything-grep.el" (0 0 0 0))
;;; Generated autoloads from anything-grep.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "anything-grep" '("anything-")))

;;;***

;;;### (autoloads nil "anything-gtags" "anything-gtags.el" (0 0 0
;;;;;;  0))
;;; Generated autoloads from anything-gtags.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "anything-gtags" '("anything-")))

;;;***

;;;### (autoloads nil "anything-ipa" "anything-ipa.el" (0 0 0 0))
;;; Generated autoloads from anything-ipa.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "anything-ipa" '("anything-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "anything-match-plugin" '("agp-c" "anything-")))

;;;***

;;;### (autoloads nil "anything-menu" "anything-menu.el" (0 0 0 0))
;;; Generated autoloads from anything-menu.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "anything-menu" '("am/" "anything-menu")))

;;;***

;;;### (autoloads nil "anything-migemo" "anything-migemo.el" (0 0
;;;;;;  0 0))
;;; Generated autoloads from anything-migemo.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "anything-migemo" '("anything-")))

;;;***

;;;### (autoloads nil "anything-multi-sources" "anything-multi-sources.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from anything-multi-sources.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "anything-multi-sources" '("anything-multi-source" "ams-")))

;;;***

;;;### (autoloads nil "anything-obsolete" "anything-obsolete.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from anything-obsolete.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "anything-obsolete" '("arfn-" "anything-")))

;;;***

;;;### (autoloads nil "anything-show-completion" "anything-show-completion.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from anything-show-completion.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "anything-show-completion" '("anything-show-completion-" "asc-" "use-anything-show-completion")))

;;;***

;;;### (autoloads nil nil ("90anything-complete.el" "anything-pkg.el"
;;;;;;  "anything-startup.el") (0 0 0 0))

...
Attempt to fix the current compiler error. Leave point at fixed code." t nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ada-mode" '("ada-" "which-func-" "wisi-inhibit-parse")))

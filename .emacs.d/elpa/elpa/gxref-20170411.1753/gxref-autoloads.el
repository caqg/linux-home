...
Update GTAGS project database for current project." t nil)

(autoload 'gxref-single-update-db "gxref" "\
Update GTAGS project database for the current file." t nil)
...
a GTAGS file is found.  See `gxref-set-project-dir' for more details." t nil)

(autoload 'gxref-xref-backend "gxref" "\
Gxref backend for Xref." nil nil)
